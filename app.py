...
def generate_reports():
    ...
    try:
        ...
        for lib_key,selected in selected_libraries.items():
            if not selected:
                continue
