...
def generate_reports():
    ...
    try:
        ...
        for idx, lib_key in enumerate(selected_libs, start=1):
            ...
            if lib_type=='movie':
                item_count=generate_movie_report_plexapi(section, output_path, cutoff_date, progress_data)
            else:
                item_count=generate_tv_report_plexapi(section, output_path, cutoff_date, progress_data)
...
def generate_movie_report_plexapi(section, output_path, cutoff_date, progress_data):
...
def generate_tv_report_plexapi(section, output_path, cutoff_date, progress_data):
